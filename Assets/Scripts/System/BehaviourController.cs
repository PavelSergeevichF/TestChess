...
public class BehaviourController : IExecute, IInitialization, ILateExecute, ICleanup, IFixedExecute, IAwake
{
    ...
    internal BehaviourController Add(IController controller)
    {
